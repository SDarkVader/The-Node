# Blueprint History — the decision record

**This is the chronological record of how NODE's architecture was arrived at: what was tried,
what was measured, what was rejected and why.** It was previously called `BLUEPRINT.md`, which
was the wrong name — a blueprint is a map of what exists now, and this is a narrative of how it
came to. The map lives in `docs/BLUEPRINT.md`; this file keeps the reasoning.

Nothing here is deleted, because the reasoning is the valuable part: several decisions in this
project were reversed once measured, and the record of *why* is what stops them being re-made.
Read it when you need to know why something is the way it is. Read `BLUEPRINT.md` when you need
to know what it currently is.
